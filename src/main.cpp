/*
  ...
  This sketch shows you how to interact with a Modbus RTU temperature and
  humidity sensor. It reads the temperature and humidity values every 5 seconds
...
SoftwareSerial soft_serial(37, 36);
float temperature;
float humidity;
